...
// Last-call-wins still applies (NewValue is the value used at runtime). This record exists solely to
// surface the divergence as a startup diagnostic; it never affects runtime resolution.
